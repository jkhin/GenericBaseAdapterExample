...
public abstract class BaseAdapter<T, L extends BaseAdapter.BaseRecyclerListener, VH extends BaseViewHolder<T, L>>
     ...
     */
    @NonNull
    protected ViewDataBinding inflate(@LayoutRes final int layout, final @Nullable ViewGroup parent, int viewType) {
    ...
    public interface OnRecyclerObjectClickListener<T> extends
